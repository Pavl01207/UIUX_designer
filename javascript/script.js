...
function documentActions(e) {
	...
	//works filter
	if (targetElement.classList.contains('resent__button-type') && !targetElement.classList.contains('active')) {
		const activeElement = document.querySelector(`.resent__button-type.active`);
		const elements = document.querySelectorAll(`.items-resent__item`);
